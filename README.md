...
Model BLS signature, public-key, and message aggregation payloads for Solana v1.

## Why this exists

Solana transaction v1 raises the maximum transaction size from 1,232 to 4,096 bytes. BLS Payload Lab explores a focused consumer use of that space while making the wire budget visible.
